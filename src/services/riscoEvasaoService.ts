...
// ------------------------------------------------------------------
// Pontos por status
// Só cobre os status de Rematrícula: o score de risco de evasão, por
// enquanto, existe apenas para esse funil (ver README.md seção 1). Os
// status de Retenção/Engajamento caem no `?? 0` abaixo, sem pontuar.
// ------------------------------------------------------------------
...
// ------------------------------------------------------------------
// Calcula para lista — só Rematrícula, excluindo rematriculados e desistentes
// ------------------------------------------------------------------
