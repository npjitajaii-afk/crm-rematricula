...
const ModalRecado: React.FC<ModalRecadoProps> = ({
  ...
  return (
    <div className="modal-overlay" onClick={(e) => { e.stopPropagation(); if (e.target === e.currentTarget) onClose(); }}>
      <div className="modal-recado" onClick={(e) => e.stopPropagation()} role="dialog" aria-modal="true" aria-labelledby="modal-recado-titulo">
        <div className="modal-recado-header">
          <h2 id="modal-recado-titulo">Enviar recado</h2>
