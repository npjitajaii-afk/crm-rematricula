...
const Grupos: React.FC = () => {
  ...
  const { grupos, outros, totalOutros } = useMemo(() => calcularGrupos(alunos), [alunos]);
  ...
  const filtroAtivo = busca.trim() !== "" || statusFiltro !== "todos" || tagFiltro !== "todas";
    ...
    <div className="grupos-page">
      ...
      <div className="grupos-header">
        ...
        <p className="grupos-subtitle">
          Segmentação automática por combinação de status + etiquetas. Cada
          combinação que aparece entre os alunos vira um grupo. Desistentes
          ficam de fora.
        </p>
      </div>
