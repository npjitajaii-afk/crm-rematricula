...
const AlunoDetails: React.FC = () => {
  ...
  // como lidas (zera o badge no Kanban). Ver database/010_whatsapp_evolution.sql.
  useEffect(() => {
  ...
  // Nome de quem cadastrou o aluno (pedido do usuário: precisa aparecer
  // quem criou o contato). createdBy guarda o id do usuário; resolvido
  // contra a lista de colaboradores/admins já carregada pelo contexto.
        ...
        <div className="lead-sidebar">
                    ...
                    <div className="checklist-progresso">
                      <div className="checklist-progresso-barra">
                        <div
                          ...
                          style={{
                            width: `${Math.round((concluidos / itens.length) * 100)}%`,
                          }}
                        />
                      </div>
                      <span>
                        {concluidos}/{itens.length} concluído
                      </span>
                    </div>
                        ...
                        <li key={item.id}>
                          <button
                            ...
                            className={`checklist-detalhe-item${
                              item.concluido ? " checklist-detalhe-item--concluido" : ""
                            }`}
                          ...
                          >
                            ...
                            <div>
                              <span className="checklist-detalhe-label">{item.label}</span>
                              {item.concluido && item.concluidoPorNome && (
                                <span className="checklist-detalhe-info">
          ...
          <div className="card">
            ...
            <div className="stats-list">
              ...
              {resumoPorAluno[aluno.id]?.ultimaMensagemEm && (
                <div className="stat-item">
                  <span className="stat-label">
                    <MessageSquare size={13} style={{ verticalAlign: "text-bottom", marginRight: 4 }} />
                    Última msg. WhatsApp
                  </span>
                  <span className="stat-value">
                    {formatDateTime(resumoPorAluno[aluno.id].ultimaMensagemEm as Date)}
                  </span>
                </div>
              )}
            </div>
